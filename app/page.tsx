                    ...
                    <div className="relative md:mt-24 mx-auto w-full max-w-4xl pt-4 text-center">
                        <div className="justify-center hidden md:flex">
                            <div
                                ...
                                <h5>Now with AI integration for large databases</h5>
                        ...
                        <h1 className="md:text-7xl my-4 font-extrabold text-4xl md:leading-tight">Save your time and costs. Let AI do the work.</h1>
                        <p className="mx-auto my-4 text-sm w-full max-w-xl text-center font-medium leading-relaxed tracking-wide">
                        Introducing Optima AI ERP suite: a personal assistant for every part of your company, ensuring everything runs smoothly, every day.
                        Automate financial reports, inventory management and much more.</p>
                ...
                <div className="container mx-auto text-center">
                    <div className="my-24">
                        ...
                        <h2 className="text-4xl font-extrabold my-4">
                            Automate your workflows with our plug-and-play ERP
                        </h2>
